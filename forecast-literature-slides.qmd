...
-   Which models to choose? Go diverse [@wangForecastCombinations50year2023]
-   How to aggregate? Hard to beat the mean [@aastveit]
:::
...
-   Compare complex models to simple ones [@makridakisStatisticalMachineLearning2018, @makridakis2022]
...
-   Machine learning approaches (ensemble learning, trees, bagging, etc.) [@petropoulosExploringSourcesUncertainty2018]
...
## Some more stuff on probabilistic forecasting
...
-   use of random effects  gained attention in machine learning literature [@saldittGradientTreeBoosting2023]
-   accounting for dependence, less parameters to estimate [@kilianMixedEffectsMachine2023]
